...
examplesExtension = SketchupExtension.new $exStrings.GetString("Ruby Script Deployment"), "/Library/Application Support/Google SketchUp 8/SketchUp/Plugins/deploy/simulate_shadow.rb"
