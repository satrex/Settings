...
# Menu Item	:   Polyline Divider
# Context Menu	:   Edit Polyline Divider
...
BZ__DIVIDER__LIST = ["BZ__Divider"]



module BZ__Divider

BZ_TYPENAME = "BZ__Divider"			#symbolic name - DO NOT TRANSLATE
BZ_MENUNAME = ["Polyline Divider", "|FR| Diviseur de Polyline", "|ES| Divisor de Polilínea"]
...
TTH_Title = ["Parameters of Polyline Divider",
             "|FR| Paramètres du Diviseur de Polyline",
			 "|ES| Parámetros de Divisor de Polilínea"]
TTH_Interval = ["Interval", "|FR| Intervalle", "|ES| Intervalo"]

#-------------------------------------------------------------------------------------------------------------
# Callback methods implementing the bezierspline required interface
#-------------------------------------------------------------------------------------------------------------

def BZ__Divider.bz_compute_curve(pts, numseg, loop, extras)
	BZ__Divider.calculate pts, loop, extras
end

def BZ__Divider.bz_ask_extras (mode, extras, pts, precision)
...
def BZ__Divider.calculate(pts, loop, extras)
	...
	while (iloop < MAX_POINTS)
		mu = BZ__Divider.intersect_ray_sphere pt1, pt2, pt, interval
...
def BZ__Divider.intersect_ray_sphere(p1, p2, sc, r)
